...
def inventario_EOQ():
    class InputForm(Form):
        D = FloatField(
            label='Valor de la demanda anual (D)', default=12000,
            validators=[validators.InputRequired()],
            render_kw=style)
        CO = FloatField(
            label='Costo de ordenar (Co)', default=25.00,
            validators=[validators.InputRequired()],
            render_kw=style)
        CH = FloatField(
            label='Costo de mantenimiento (Ch)', default=0.50,
            validators=[validators.InputRequired()],
            render_kw=style)
        P = FloatField(
            label='Costo por unidad del producto (P)', default=2.50,
            validators=[validators.InputRequired()],
            render_kw=style)
        TE = IntegerField(
            label='Tiempo de espera del producto en días (Tespera)', default=5,
            validators=[validators.InputRequired()],
            render_kw=style)
        DA = IntegerField(
            label='Días habíles del año (DiasAno)', default=250,
            validators=[validators.InputRequired()],
            render_kw=style)
        PE = IntegerField(
            label='Periodo del inventario (Pe)', default=30,
            validators=[validators.InputRequired()],
            render_kw=style)
...
def inventario_general():
    class InputForm(Form):
        D = IntegerField(
            label='Inventario inicial (D)', default=12000,
            validators=[validators.InputRequired()],
            render_kw=style)
        CO = FloatField(
            label='Costo de ordenar (Co)', default=25.00,
        ...
        P = FloatField(
            ...
            render_kw=style)
        TE = IntegerField(
            label='Cantidad demandada del producto (Te)', default=400,
            validators=[validators.InputRequired()],
            render_kw=style)
        DA = IntegerField(
            label='Cantidad que se adquiere de producto al agotarse (Da)', default=500,
            validators=[validators.InputRequired()],
            render_kw=style)
        PE = IntegerField(
            label='Tiempo en días que tarda el producto (Pe)', default=3,
            validators=[validators.InputRequired()],
            render_kw=style)
        CI = IntegerField(
            label='Cantidad a mostrar en la tabla (Ci)', default=15,
            validators=[validators.InputRequired()],
            render_kw=style)
    ...
    if request.method == 'POST' and form.validate():
        ...
        def make_data(product, policy, periods):
            ...
            for period in period_lst:
                ...
                if period >= 1:
                    df['INV_INICIAL'][period] = df['INV_FINAL'][period -
                                                                1] + order_l[period - 1].quantity
        ...
        producto = product("Mesa", PR, Co, II, "Constant",
                           DP, 450, 400, "Constant", TA, 3, 4)
...
def inventario_empresa():
    ...
    if request.method == 'POST' and form.validate():
        ...
        producto = product("Mesa", P, Co, II, "Constant",
                           D, 450, 400, "Constant", T, 3, 4)
...
def linea_espera_aditivo():
    ...
    class InputForm(Form):
        CH = IntegerField(
            ...
            render_kw=style)
        M = IntegerField(
            label='Módulo (m)', default=1113,
            validators=[validators.InputRequired()],
            render_kw=style)
        A = IntegerField(
            label='Multiplicador (a)', default=26,
            validators=[validators.InputRequired()],
            render_kw=style)
        X0 = IntegerField(
            label='Semilla (Xn)', default=109,
            validators=[validators.InputRequired()],
            render_kw=style)
        C = IntegerField(
            label='Incremento (c)', default=111,
            validators=[validators.InputRequired()],
            render_kw=style)
        D = FloatField(
            label='\( Landa \ \lambda \)', default=1.333,
